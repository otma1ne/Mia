...
const REGLEMENT = `RÈGLEMENT INTÉRIEUR — MIA Digital

Article 1 — Objet
Le présent règlement intérieur s'applique à toute personne inscrite à une formation dispensée par MIA Digital. Il a pour objet de préciser les règles de conduite et de fonctionnement au sein de nos formations, qu'elles soient en présentiel, en ligne ou en format hybride.

Article 2 — Accès aux formations
L'accès à la formation est réservé aux personnes ayant complété leur dossier d'inscription et signé les documents contractuels. Tout stagiaire doit se présenter aux sessions à l'heure convenue. En cas de retard répété ou d'absence injustifiée, MIA Digital se réserve le droit d'exclure le stagiaire du programme.
...
Les ressources pédagogiques (supports de cours, vidéos, exercices) sont mises à disposition à titre strictement personnel. Leur reproduction, diffusion ou commercialisation sans autorisation écrite de MIA Digital est interdite.

Article 6 — Confidentialité
Les stagiaires s'engagent à ne pas divulguer les contenus pédagogiques propriétaires de MIA Digital ni les informations confidentielles échangées en session à des tiers.
...
MIA Digital — Organisme de formation professionnelle`

const CGV = `CONDITIONS GÉNÉRALES DE VENTE (CGV) — MIA Digital

Article 1 — Identification de l'organisme
MIA Digital est un organisme de formation professionnelle continue. Toute inscription à nos formations implique l'acceptation pleine et entière des présentes conditions générales de vente.
...
- Virement bancaire
- Chèque à l'ordre de MIA Digital
...
En cas de litige, une solution amiable sera recherchée en priorité. À défaut d'accord, les tribunaux compétents seront ceux du ressort du siège social de MIA Digital.
