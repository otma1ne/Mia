...
export default function CGVPDF({ content, centerName, generatedAt, signature }: CGVPDFProps) {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Title */}
        <Text style={styles.docTitle}>Conditions Générales de Vente</Text>
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>{centerName} — Conditions Générales de Vente</Text>
